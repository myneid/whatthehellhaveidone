...
return [
    ...
    */
    ...
    'permissions' => [
        'NSCameraUsageDescription' => 'Used to capture photos and videos for card attachments.',
        'NSPhotoLibraryUsageDescription' => 'Used to pick photos and files for board and card attachments.',
    ],
