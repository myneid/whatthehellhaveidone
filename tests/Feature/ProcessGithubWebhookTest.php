...
use App\Jobs\RequestGithubCopilotReview;
...
it('moves a linked card to the configured review list and queues copilot review when a human opens a pull request', function (): void {
    Bus::fake([RequestGithubCopilotReview::class]);
    ...
    $event = GithubWebhookEvent::create([
        ...
        'delivery_id' => 'delivery-human-review-1',
        'payload' => [
            'action' => 'opened',
            'pull_request' => [
                'number' => 9,
...
it('does not request copilot review when the linked card was assigned to a human', function (): void {
    Bus::fake([RequestGithubCopilotReview::class]);
    ...
    $event = GithubWebhookEvent::create([
        'github_repository_id' => $repository->id,
        'event_type' => 'pull_request',
        'delivery_id' => 'delivery-human-no-review-1',
        'payload' => [
            'action' => 'opened',
            'pull_request' => [
                'number' => 9,
    ...
    Bus::assertNotDispatched(RequestGithubCopilotReview::class);
});
